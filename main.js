...
const displayTasks = () => {
  ...
  if (selectedNav.getAttribute("id") === "all-task-btn") {
    taskToDisplay = _task__WEBPACK_IMPORTED_MODULE_1__.taskList;
  }
  //today task
  else if (selectedNav.getAttribute("id") === "today-task-btn") {
    taskToDisplay = _task__WEBPACK_IMPORTED_MODULE_1__.taskList.filter(
  ...
  // week task
    ...
    taskToDisplay = _task__WEBPACK_IMPORTED_MODULE_1__.taskList.filter(
      (task) =>
        ...
        (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.taskDuedate), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(todayDate)) >=
          0 &&
        (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.taskDuedate), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(todayDate)) <= 7
    );
  }
  //important task
  ...
  //completed task
    ...
    taskToDisplay = _task__WEBPACK_IMPORTED_MODULE_1__.taskList.filter((task) => task.isCompleted === true);
  }
  //all projects tasks
  else {
    taskToDisplay = _task__WEBPACK_IMPORTED_MODULE_1__.taskList.filter(
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "iconClickHandlers": () => (/* binding */ iconClickHandlers),
/* harmony export */   "navClickHandlers": () => (/* binding */ navClickHandlers)
/* harmony export */ });
...
const iconClickHandlers = () => {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (e.target.classList.contains("project-trash-icon")) {
      ...
      (0,_domHandlers__WEBPACK_IMPORTED_MODULE_0__.domPopup)("deleteprojectform-popup");
    }
    ...
    if (e.target.classList.contains("task-edit-icon")) {
      ...
      selectedTask = (0,_task__WEBPACK_IMPORTED_MODULE_2__.getSeletedTask)(selectedTaskID);
    ...
    if (e.target.classList.contains("task-trash-icon")) {
      ...
      (0,_domHandlers__WEBPACK_IMPORTED_MODULE_0__.domPopup)("deletetaskform-popup");
    }
  ...
  document.addEventListener("submit", (e) => {
    ...
    if (e.target.getAttribute("name") === "editProjectForm") {
      ...
      (0,_project__WEBPACK_IMPORTED_MODULE_1__.editProject)(projectTitle, newProjectTitle);
      (0,_task__WEBPACK_IMPORTED_MODULE_2__.updateProjectToTask)(projectTitle, newProjectTitle);
      (0,_domHandlers__WEBPACK_IMPORTED_MODULE_0__.displayProjectsToNav)();
    ...
    if (e.target.getAttribute("name") === "deleteProjectForm") {
      ...
      (0,_task__WEBPACK_IMPORTED_MODULE_2__.deleteTasksOnDeletingProject)(projectTitle);
      (0,_domHandlers__WEBPACK_IMPORTED_MODULE_0__.displayProjectsToNav)();
    ...
    if (e.target.getAttribute("name") === "createTaskForm") {
      ...
      (0,_task__WEBPACK_IMPORTED_MODULE_2__.addTaskToList)(
        taskTitle,
        taskDescription,
        taskDuedate,
        taskPriority,
    ...
    if (e.target.getAttribute("name") === "deleteTaskForm") {
      (0,_task__WEBPACK_IMPORTED_MODULE_2__.deleteTask)(selectedTaskID);
      (0,_domHandlers__WEBPACK_IMPORTED_MODULE_0__.domPopup)("deletetaskform-popup");
    }
    (0,_domHandlers__WEBPACK_IMPORTED_MODULE_0__.displayTasks)();
...
/* harmony export */   "deleteTasksOnDeletingProject": () => (/* binding */ deleteTasksOnDeletingProject),
...
/* harmony export */   "updateProjectToTask": () => (/* binding */ updateProjectToTask)
/* harmony export */ });
//Load task list
let taskList =
